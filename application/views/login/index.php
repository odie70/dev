...
<html lang="en">
  <head>
    ...
    <style>
      @import url('<?= base_url() ?>assets/inter/inter.css');
      :root {
          ...
          <div class="card-body">
            ...
            <form action="" method="post">
              <div class="mb-3">
                ...
                <input type="text" name="username" class="form-control" placeholder="your email or username" autocomplete="off">
              </div>
              <div class="mb-2">
              ...
              <div class="mb-2">
                <label class="form-check">
                  <a class="text-danger"><?= $this->session->flashdata('message_login_error') ?></a>
                </label>
              </div>
