        ...
        <div class="col">
          ...
          <div class="page-pretitle">
            <ol class="breadcrumb breadcrumb-arrows" aria-label="breadcrumbs">
              ...
              <li class="breadcrumb-item active" aria-current="page">Produk</a></li>
            </ol> 
          </div>
          <h2 class="page-title">
            <?= $title ?>
            ...
            <div class="col-12">
              <div class="card">
                <div class="card-header">
                  <h3 class="card-title"><a href="<?= base_url('produk') ?>/data">Database Produk</a></h3>
                </div>
                <div class="card-body">
                  <div class="row">
                    <div class="table-responsive">
                      <table id="tableProdukDash" class="table card-table table-vcenter text-nowrap datatable border-x-0">
                        ...
                        <tbody><?php foreach ($data_produk as $row) : ?>
                          <tr>
                            <td><?= $row->id_produk ?></td>
                            <td><a href="<?= base_url('produk/detail/'.$row->id_produk); ?>"><?= $row->kode_produk ?></a></td>
