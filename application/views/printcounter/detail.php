      ...
      <div class="row g-2 align-items-center">
        ...
        <div class="col-auto ms-auto d-print-none">
          <div class="btn-list">
            ...
            <a href="<?= base_url('printcounter/hapus/'. $data_printcounter->id_print); ?>" class="btn btn-danger d-none d-sm-inline-block">
              <i class="ti ti-trash d-sm-inline-block"></i> Hapus
            </a>
            <a href="<?= base_url('printcounter/hapus/'. $data_printcounter->id_print); ?>" class="btn btn-danger d-sm-none btn-icon">
              <i class="ti ti-trash d-sm-inline-block"></i>
            </a>
            <a href="<?= base_url('printcounter/ubah/'. $data_printcounter->id_print); ?>" class="btn btn-<?= $current_user->theme ?> d-none d-sm-inline-block">
              <i class="ti ti-pencil d-sm-inline-block"></i> Ubah
            </a>
            <a href="<?= base_url('printcounter/ubah/'. $data_printcounter->id_print); ?>" class="btn btn-<?= $current_user->theme ?> d-sm-none btn-icon">
                  ...
                  <div class="row align-items-center">
                    ...
                    <div class="col">
                      ...
                      <div class="font-weight-medium">
                        <?= $data_printcounter->nama_pelanggan ?> - <?= $data_printcounter->no_hp ?>
                      </div>
                    </div>
                  </div>
                </div>
            ...
            <div class="col-sm-6 col-lg-4">
              <div class="card card-sm">
                <div class="card-body">
                  <div class="row align-items-center">
                    <?php
                      $status = $data_printcounter->status;
                      if ($status == 'Antri')
                        echo 
              ...
              <div class="table-responsive">
                <table class="table table-vcenter card-table border-x-0">
                  <tbody>
                    <tr>
                      <td>Device(s)</td>
                      <td><?= $data_printcounter->nama_device ?></td>
                    </tr>
                    <tr>
                      <td>S/N</td>
                      <td><?= $data_printcounter->no_seri ?></td>
                    </tr>
                    <tr>
                      <td>Acc</td>
                      <td><?= nl2br ("$data_printcounter->kelengkapan"), false; ?></td>
                    </tr>
                    <tr>
                    <tr>
                      <td>Perbaikan</td>
                      <td><?= $data_printcounter->perbaikan ?></td>
                    </tr>
                    <tr>
                      <td>Catatan</td>
                      <td><?= nl2br ("$data_printcounter->catatan"), false; ?></td>
                      <tr>
                      <td>Jasa</td>
                      <td><?= nl2br ("$data_printcounter->solusi"), false; ?></td>
                    </tr>
                    <td>Biaya Jasa</td>
                      <td>
                        <?php
                          $biaya = number_format((float)$data_printcounter->biaya, 2, ',', '.');
                          echo $biaya;
                        ?>
                      </td>
                    </tr>
          ...
          <div class="card">
            ...
            <div class="card-body">
              ...
              <ul class="steps steps-vertical">
                ...
                $Antri = "<li class='step-item active'>
                          ...
                          <div class='text-muted'><i class='ti ti-calendar-time'></i> $data_printcounter->tgl_masuk <i class='ti ti-clock'></i> $data_printcounter->jam_masuk</div>
                          </li>";
                $Proses = "<li class='step-item'>
                          ...
                          <div class='text-muted'><i class='ti ti-calendar-time'></i> $data_printcounter->tgl_proses <i class='ti ti-clock'></i> $data_printcounter->jam_proses</div>
                          </li>";
                $Konfirmasi = "<li class='step-item'>
                          ...
                          <div class='text-muted'><i class='ti ti-calendar-time'></i> $data_printcounter->tgl_konfirmasi <i class='ti ti-clock'></i> $data_printcounter->jam_konfirmasi</div>
                          </li>";
                  $Selesai = "<li class='step-item'>
                          ...
                          <div class='text-muted'><i class='ti ti-calendar-time'></i> $data_printcounter->tgl_keluar <i class='ti ti-clock'></i> $data_printcounter->jam_keluar</div>
                          </li>";
            ...
            <div class="card-footer">
              <div class="btn-list">
                <?php
                    $status = $data_printcounter->status;
                    $invoice = $data_printcounter->no_invoice;
                    $linknota = base_url('service/nota/' . $data_printcounter->id_print);
                    $linkinvoice = base_url('service/invoice/' . $data_printcounter->id_print);
                    $linkselesai = base_url('service/selesai/' . $data_printcounter->id_print);
