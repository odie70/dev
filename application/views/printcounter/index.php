    ...
    <div class="container-xl">
      <div class="row g-2 align-items-center">
        ...
        <div class="col-auto ms-auto d-print-none">
          <div class="btn-list">
            <!-- Next Button -->
            <a href="<?= base_url('printcounter') ?>/data" class="btn btn-<?= $current_user->theme ?> d-none d-sm-inline-block">
              <i class="ti ti-list d-sm-inline-block"></i> Database
            </a>
            <a href="<?= base_url('printcounter') ?>/data" class="btn btn-<?= $current_user->theme ?> d-sm-none btn-icon">
            ...
            <div class="col-sm-3 col-lg-12">
              <div class="card">
                <div class="card-header">
                  <h3 class="card-title"><a href="<?= base_url('printcounter') ?>/data">Print Counter</a></h3>
                </div>
                <div class="card-body">
                  <div class="row">
                    <div class="table-responsive">
                      <table id="tableServiceDash" class="table card-table table-vcenter text-nowrap datatable border-x-0">
                        ...
                        <tbody>
                          ...
                          <tr>
                            <td><?= $row->id_print ?></td>
                            <td><a href="<?= base_url('printcounter/detail/'.$row->id_print); ?>"><?= $row->invoice_print ?></td>
