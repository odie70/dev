        ...
        <div class="container-xl">
          ...
          <div class="navbar-nav flex-row order-md-last">
            <div class="d-none d-md-flex">
              ...
              <!-- Start Responsive -->
              <a href="?theme=dark" class="btn btn-pink d-sm-none btn-icon">
                <i class="ti ti-moon d-sm-inline-block"></i>
              </a>
              <a href="?theme=light" class="btn btn-pink d-sm-none btn-icon">
                <i class="ti ti-sun d-sm-inline-block"></i>
              </a>
              <!-- End Responsive -->
            ...
            <div class="nav-item dropdown">
              <a href="#" class="nav-link d-flex lh-1 text-reset p-0" data-bs-toggle="dropdown" aria-label="Open user menu">
                ...
                <!-- <div class="d-none d-xl-block ps-2">
                  ...
                  <div class="mt-1 small text-muted"><?= $current_user->email ?></div>
                </div> -->
              </a>
